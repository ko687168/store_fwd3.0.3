...
const char* tunable_user_pass_file;
const char* tunable_pid_file;
const char* tunable_lock_file;
...
tunables_load_defaults()
{
    ...
    install_str_setting(0, &tunable_user_pass_file);
    install_str_setting(0, &tunable_pid_file);
    install_str_setting(0, &tunable_lock_file);
}
